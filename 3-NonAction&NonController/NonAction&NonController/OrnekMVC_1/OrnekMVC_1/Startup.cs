...
namespace OrnekMVC_1
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                //Default olan endpoint þemasý--- Bu uygulamaya yapýlacak olan istekler bu þemaya uygun bir þekilde yapýlacaktýr.
                //{Controller=Home}/{action=Index}/{id?}---Endpoint çalýþma mantýðý
                //request------- http://www...com/personel(Controller)/getir(Action)
                //request------- http://www...net/a/b
                //Contorller boþ geliyorsa home , actionda boþ geliyorsa Index gelir.
                //Endpoint tanýmlamasýnda süslü parantezler içerisinde parametre tanýmlanabilir.Bu parametreler herhangi bir isimde olabilir.
                //{Controller}/{action}/{hilmi}
                //Controller ve action => Öntanýmlý olan parametrelerdir.
